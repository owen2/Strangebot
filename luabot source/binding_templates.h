...
{
  return thunk<R>::push(L, (g_pDefconInterface->*F)(lbot_checkID(L, 1), lbot_checkID(L, 2)));
}
...
{
  return thunk<R>::push(L, (g_pDefconInterface->*F)(static_cast<float>(luaL_checknumber(L, 1)), static_cast<float>(luaL_checknumber(L, 2))));
}
...
{
  lbot_pushnumber(L, (g_pDefconInterface->*F)(static_cast<float>(luaL_checknumber(L, 1)), static_cast<float>(luaL_checknumber(L, 2)),
    static_cast<float>(luaL_checknumber(L, 3)), static_cast<float>(luaL_checknumber(L, 3))));
  return 1;
}
